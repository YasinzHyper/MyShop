          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  Color.fromRGBO(117, 131, 255, 1).withOpacity(0.5),
                  Color.fromRGBO(117, 255, 188, 1).withOpacity(0.8),
                ],
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: RadialGradient(
                          colors: [
                            Color.fromARGB(189, 181, 63, 63),
                            Color.fromARGB(62, 245, 134, 255),
                          ],
...
class _AuthCardState extends State<AuthCard>
  ...
  void initState() {
    ...
    //re draw screen every 60 milliseconds
